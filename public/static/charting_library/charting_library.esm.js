...
let i = !1;
function o() {
	return "CL v27.006 (internal id c7d57a22 @ 2024-05-21T16:14:30.134Z)";
}
const s = class {
	constructor(n) {
		var o, s;
		...
		"dark" ===
			...
			this._options.debug &&
				(i ||
					((i = !0),
					console.log(
						"Using CL v27.006 (internal id c7d57a22 @ 2024-05-21T16:14:30.134Z)"
					))),
			this._create();
	}
	setDebugMode(t) {
	...
	_render(t) {
		...
		const i = (function (t, e) {
			...
			const o = new URL(`${t || ""}`, location.href).href,
				s = JSON.parse(
					'["bundles/runtime.1f6691a05496db116913.js","bundles/__LANG__.4716.e4ac74dfc9ec5374b00c.js","bundles/6150.bda60280b05cea478076.css","bundles/5142.2c34c8656148cc5203b7.js","bundles/library.ed30e653462ab0610aff.js"]'
				),
		...
		const s =
			...
			(this._options.time_scale
				...
				: "");
		return [
			`<iframe\n\t\tid="${this._id}" class="ddd" name="${this._id}" src="${
				o.href
